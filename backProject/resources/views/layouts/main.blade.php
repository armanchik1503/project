                    ...
                    <div class="row">
                        <div class="col">
                            <div class="header_content d-flex flex-row align-items-center justify-content-start">
                                <div class="logo"><a href="{{route('home')}}">AREKE.</a></div>
                                <nav class="main_nav">
                                    <ul>

                                        <a style="margin-right:46px; font-size: 16px;
                                                    font-weight: 600;
                                                    color: #767676;
                                                    ...
                                                    transition: all 200ms ease;" href="{{route('home')}}">Home</a>
                ...
                <div class="row">
                    <div class="col">
                        <div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                            <div class="footer_logo"><a href="/home">AREKE.</a></div>
